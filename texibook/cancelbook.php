				...
				<div class="container">
					<div class="row justify-content-center">
                        <div class="col-md-6">
                          ...
                          <h4>Bookin Cancellation Panel</h4>
                          <br>
						  <?php 
						  session_start();
...
<
                            ...
                            <br><br>
                                ...
                                <?php
                                  ...
                                  ?>
                                  <p class="alert alert-danger">Passenger Not Found</p>
                                  <?php
                              }
                          ...
                          <div class="">
                            <form action="" method="POST">
                                ...
                                <br>
                                <button name="search" class="btn btn-black">Search Passenger</button>
                            </form>
                          </div>
                        ...
                        <?php 
                            if(isset($_POST['savechanges'])){
								...
								$updatestatus = "UPDATE `booking` SET `status` = 'cancel' WHERE phone = '$id'";
								$runupdate = mysqli_query($conn, $updatestatus);
								if($runupdate){
									?>
									<p class="alert alert-success">Cancel Successfully</p>
									<?php
								}else{
									?>
