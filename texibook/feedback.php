                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-8">
                            ...
                            <form action="" method="POST">
                                ...
                                <div class="form-group">
                                Write your Feedback
                                <textarea name="feedback" required class="form-control"></textarea>
                                </div>

                                <div class="form-group">
                                   <button name="send" class="btn btn-primary">Send Feeback</button>
                                </div>
                            </form>
                        </div>
                    </div>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-8">
                            ...
                            if(isset($_POST['send'])){
                                ...
                                $savefeed = "INSERT INTO feedback(fname,fcomment) VALUES('$name','$feedback')";
                                $runsave =  mysqli_query($conn, $savefeed);
                                if($runsave){
                                    ?>
                                    <p class="alert alert-success">FeedBack Send Successfully</p>
                                    <?php
                                }else{
                                    ?>
                                    <p class="alert alert-danger">FeedBack Not Send</p>
                                    <?php
                                }
                            }
                            ?>
